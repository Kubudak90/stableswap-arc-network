...
/**
 * @title TestTokenFaucetV2
 * @notice Faucet for test tokens on Arc Testnet - includes USDY
 */
contract TestTokenFaucetV2 is Ownable {
    ...
    function claimTokens() external {
        ...
        require(
            testUSDY.balanceOf(address(this)) >= FAUCET_AMOUNT,
        ...
        testUSDY.transfer(msg.sender, FAUCET_AMOUNT);
        
        emit TokensClaimed(msg.sender, FAUCET_AMOUNT, FAUCET_AMOUNT, FAUCET_AMOUNT);
    }
    ...
    function refillFaucet() external onlyOwner {
        ...
        testUSDY.transferFrom(msg.sender, address(this), FAUCET_AMOUNT * 100);
    }
