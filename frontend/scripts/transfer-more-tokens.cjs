...
async function main() {
  ...
  // Transfer amounts (5000 tokens each)
  const transferAmount = hre.ethers.parseUnits("5000", 6); // 6 decimals
  ...
  console.log("\n🎉 More tokens transferred successfully!");
}
