    ...
    <div className="page-container">
      <div style={{
        ...
        <main style={{ flex: 1, minWidth: '300px' }}>
          <div className="card">
            <div className="card-content" style={{ padding: '2rem', textAlign: 'left', lineHeight: '1.8', backgroundColor: '#ffffff', borderRadius: '0.5rem' }}>
              ...
              {activeSection === 'overview' && (
                <>
                  ...
                  <p style={{ color: '#1a1a1a', marginBottom: '1.5rem', fontSize: '1.1rem' }}>
                  ...
                  <h2 style={{ fontSize: '1.25rem', fontWeight: '600', color: '#1a1a1a', marginTop: '2rem', marginBottom: '1rem' }}>
                  ...
                  <ul style={{ color: '#1a1a1a', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>2-Pool</h4>
                      <p style={{ fontSize: '0.875rem', color: '#1a1a1a' }}>
                        tUSDC/tUSDT pair for efficient stablecoin swaps
                      </p>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>3-Pool</h4>
                      <p style={{ fontSize: '0.875rem', color: '#1a1a1a' }}>
                        tUSDC/tUSDT/tUSDY for broader liquidity
                      </p>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>LP Staking</h4>
                      <p style={{ fontSize: '0.875rem', color: '#1a1a1a' }}>
                        Stake LP tokens to earn ASS rewards
                      </p>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>ASS Staking</h4>
                      <p style={{ fontSize: '0.875rem', color: '#1a1a1a' }}>
              ...
              {activeSection === 'getting-started' && (
                <>
                  <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#1a1a1a', marginBottom: '1.5rem' }}>
                    Getting Started
                  </h1>

                  <h2 style={{ fontSize: '1.25rem', fontWeight: '600', color: '#1a1a1a', marginBottom: '1rem' }}>
                    1. Install MetaMask
                  </h2>
                  <p style={{ color: '#1a1a1a', marginBottom: '1.5rem' }}>
              ...
              {activeSection === 'swap' && (
                <>
                  ...
                  <ol style={{ color: '#1a1a1a', paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
                  ...
                  <div style={{ display: 'grid', gap: '1rem' }}>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', color: '#1a1a1a' }}>2-Pool</h4>
                      <p style={{ color: '#1a1a1a', fontSize: '0.875rem' }}>tUSDC ↔ tUSDT</p>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', color: '#1a1a1a' }}>3-Pool</h4>
                      <p style={{ color: '#1a1a1a', fontSize: '0.875rem' }}>tUSDC ↔ tUSDT ↔ tUSDY (any direction)</p>
                    </div>
                  </div>
                </>
              )}
              ...
              {activeSection === 'staking' && (
                <>
                  ...
                  <div style={{
                    ...
                    <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>Reward Rates</h4>
              ...
              {activeSection === 'faucet' && (
                <>
                  ...
                  <div style={{ display: 'grid', gap: '0.75rem', marginBottom: '1.5rem' }}>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem', display: 'flex', justifyContent: 'space-between' }}>
                      <span style={{ fontWeight: '500' }}>tUSDC</span>
                      <span style={{ color: '#1a1a1a' }}>Test USD Coin</span>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem', display: 'flex', justifyContent: 'space-between' }}>
                      <span style={{ fontWeight: '500' }}>tUSDT</span>
                      <span style={{ color: '#1a1a1a' }}>Test Tether</span>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem', display: 'flex', justifyContent: 'space-between' }}>
                      <span style={{ fontWeight: '500' }}>tUSDY</span>
                      <span style={{ color: '#1a1a1a' }}>Test USD Yield</span>
                    </div>
                  </div>
              ...
              {activeSection === 'tokenomics' && (
                <>
                  ...
                  <div style={{ display: 'grid', gap: '1rem', marginBottom: '1.5rem' }}>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>Total Supply</h4>
                      <p style={{ color: '#1a1a1a', fontSize: '1.25rem' }}>100,000,000 ASS</p>
                    </div>
                    <div style={{ padding: '1rem', backgroundColor: '#f5f5f5', borderRadius: '0.5rem' }}>
                      <h4 style={{ fontWeight: '600', marginBottom: '0.5rem', color: '#1a1a1a' }}>Decimals</h4>
                      <p style={{ color: '#1a1a1a', fontSize: '1.25rem' }}>18</p>
                    </div>
                  </div>
